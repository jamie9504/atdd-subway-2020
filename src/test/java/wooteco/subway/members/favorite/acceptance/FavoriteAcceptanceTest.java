...
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_목록_조회_요청;
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_목록_조회됨;
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_삭제_요청;
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_삭제됨;
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_생성됨;
import static wooteco.subway.members.favorite.acceptance.step.FavoriteAcceptanceStep.즐겨찾기_생성을_요청;
...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    private Long 지하철_노선_등록되어_있음(String name, String color, int extraFare) {
        ExtractableResponse<Response> createLineResponse1 = LineAcceptanceStep
            .지하철_노선_등록되어_있음(name, color, extraFare);
